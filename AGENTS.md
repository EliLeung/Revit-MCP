# Revit-MCP contributor instructions

Modified from the upstream agent guide for Revit-MCP on 2026-09-15.
...
- Transport checks: dotnet run --project tests/RevitMcp.TransportTests/TransportTests.csproj -c Release
