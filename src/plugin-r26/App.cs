...
namespace RvtMcp.Plugin
{
    public class App : IExternalApplication
    {
        ...
        private ConnectionManagerWindow _connectionWindow;
        ...
        public void ShowConnectionManager(IntPtr owner)
        {
            if (_connectionWindow == null || !_connectionWindow.IsLoaded) {
                _connectionWindow = new ConnectionManagerWindow(() => Transport as PipeTransportServer);
                new System.Windows.Interop.WindowInteropHelper(_connectionWindow).Owner = owner;
                _connectionWindow.Show();
            } else { _connectionWindow.Activate(); }
        }
